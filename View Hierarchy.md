...
#### 實驗發現，一旦present後，位於被present ViewController下方的所有ViewController都不能再present了，因為其presentedViewController都不等於nil，所以要確保viewcontroller能被present，要先從rootViewController開始，找出首個presentedViewController == nil 的 ViewController然後用該ViewController呼叫present
